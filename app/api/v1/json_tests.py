...
* make sure FastAPI is using orjson to serialize responses
* get rid of concat at all and use a serialization library like orjson
* stream responses does not help in this scenario
"""

router = APIRouter(tags=["json_tests"])
...
_all_items = [
    ...
    Item(
        ...
        description="A battery powered by a miniature universe.",
    ),
    Item(
        name="Mega Seeds",
        description="Seeds from Mega Fruit, for smuggling past customs.",
    ),
    Item(
        name="Concentrated Dark Matter",
        description="Fuel that powers faster-than-light travel.",
    ),
